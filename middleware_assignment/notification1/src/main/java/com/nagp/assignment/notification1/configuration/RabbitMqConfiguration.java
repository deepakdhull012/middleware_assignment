package com.nagp.assignment.notification1.configuration;


import com.nagp.assignment.notification1.consumer.OrderQueueConsumer;
...
public class RabbitMqConfiguration {
    ...
    SimpleMessageListenerContainer container(ConnectionFactory connectionFactory,
        ...
        container.setQueueNames(notification1QueueName);
